...
<body>
    ...
    <div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
        ...
        <div class="container-md py-5">
            ...
            <?php $sector = $array[0]; ?>
            <form action="/coletek/setores/atualizar" method="post">
                <div class="mb-3">
                    <label for="name" class="form-label">Nome</label>
                    <input name="name" value="<?php echo $sector->getName(); ?>" type="text" class="form-control" id="name" placeholder="Digite o seu nome" required>
                </div>
