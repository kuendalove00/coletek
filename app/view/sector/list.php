                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="remover" method="post">
                                        <a href="editar?id=<?php echo $sector->getId();?>" type="button" class="btn btn-warning"><i style="color: white;" class="bi bi-pencil-square"></i></a>
                                        <button type="submit" value="<?php echo $sector->getId();?>" name="id" class="btn btn-danger"><i style="color: white;" class="bi bi-pencil-square"></i></button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
