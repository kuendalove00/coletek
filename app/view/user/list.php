...
<body>
    ...
    <div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
        ...
        <div class="mb-3">
            <a href="" type="button" class="btn btn-primary">Adicionar Novo</a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <form action="" method="post">
                            <a href="" type="button" class="btn btn-success"><i class="bi bi-plus-square"></i></a>
                            <a href="" type="button" class="btn btn-warning"><i style="color: white;"
                            class="bi bi-pencil-square"></i></a>
                            <submit type="button" class="btn btn-danger"><i class="bi bi-trash3"></i></submit>
                        </form>
                    </td>
                </tr>
            </tbody>
